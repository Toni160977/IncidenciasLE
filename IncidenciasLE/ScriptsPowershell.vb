...
Imports System.Text
Imports System.IO
Public Class Scripts_Powershell
    Private Sub Scripts_Powershell_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Function RunScript2(ByVal scriptText As String, parameters As Dictionary(Of String, String)) As String
        ...
        'MyPipeline.Commands.AddScript(myCommand.ToString)
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        TextBox5.Text = RunScript2(LoadScript("\\192.168.1.3\c$\Informatica\IncidenciasLE\Scripts\BorraCarpeta.ps1"), dict)
    End Sub
